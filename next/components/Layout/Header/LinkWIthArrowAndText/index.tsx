...
const LinkWIthArrowAndText:FC<PropTypes> = ({ text, color = '#2D2D2D' }: PropTypes) => {
  ...
  return (
    <div className="flex justify-between items-center cursor-pointer" onMouseEnter={() => setRotateArrow(true)} onMouseLeave={() => setRotateArrow(false)}>
      <div className="text-xs w-[70%] md:w-full sm:text-base font-tt md:h14 xl:h12 3xl:h11 uppercase" dangerouslySetInnerHTML={{ __html: text }} />
...
export default LinkWIthArrowAndText;
